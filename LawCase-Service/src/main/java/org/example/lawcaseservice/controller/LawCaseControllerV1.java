...
@Slf4j
@Tag(name = "LawCase v1", description = "CRUD operations for law office lawCases (API v1)")
@Validated
public class LawCaseControllerV1 {

    private final LawCaseService service;

    public LawCaseControllerV1 (LawCaseService service) {this.service = service;}
